...
description: "Rudi Foodi saves completion times to localStorage by default and to Firebase Firestore when configured. Learn the score schema, write path, and entry UI."
---
