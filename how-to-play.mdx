...
<Note>
  The golden eight-pointed star (`endingStar`) repositions itself on every level-up. If you run into it at any point, a meteor event begins — see **Endings** below.
</Note>
...
Clones are additional copies of Rudi that follow you around the world. They appear from Pink power-ups (3 at once), Cyan power-ups (1 at a time), and automatically at level 10+.
