...
<CardGroup cols={2}>
  ...
  <Card title="5 Power-Up Types" icon="bolt">
    Blue (speed stack), Yellow (big Rudi), Red (small Rudi), Pink (spawn 3 clones), and Cyan (spawn 1 clone). Each triggers a polished squash-and-stretch animation on Rudi.
  </Card>
