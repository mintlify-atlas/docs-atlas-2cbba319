---
title: "Scoring, Treat Goals, and Level Progression"
...
Two special milestone events trigger automatically when the score threshold is crossed:

| Score Reached | Event |
| ------------- | ----- |
| 10 treats collected (cumulative across level) | **Rudi Spin Mode** activates — Rudi rotates continuously on the Z-axis |
| 20 treats collected (cumulative across level) | **Rudi Dance Mode** activates — Rudi's head bobs in a sine wave |
